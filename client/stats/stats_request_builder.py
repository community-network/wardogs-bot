...
class StatsRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/stats{?discord_id*,id*,steam_id*}", path_parameters)
    
    async def get(self,request_configuration: Optional[RequestConfiguration[StatsRequestBuilderGetQueryParameters]] = None) -> Optional[PlayerStats]:
        """
        Get your gathered stats via your, id, steam_id or discord_id
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        Returns: Optional[PlayerStats]
        """
        ...
        return await self.request_adapter.send_async(request_info, PlayerStats, error_mapping)
